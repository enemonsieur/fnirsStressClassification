...
filterParams = FilterParams(
	...
	fir_design='firwin',
	phase='zero-double')
# firwin = time-domain design technique
#  heart rate: frequency of 1.2 or 1.3, deswegen [1,1.9] ausgefiltert bei filterParams
...
def plot_raw_fn_diff(a, b, c, text1="Raw Data", text2="S1 Function", text3="First Difference"):
    ...
    return
#%%
path_dict={'subj6': ['2021-10-06_003', 'log_data', [(27.90, 142.47), (4630.59, 4732.28)]],
			'subj7': ['2021-10-25_001', 'log_data', [(15.39, 161.10), (3700.05, 3825.94)]],
			'subj8': ['2021-10-26_002', 'log_data', [(25.22, 112.73),	(4377.42, 4456.86)]],
			#'09_sub_Katharina': ['2021-10-28_002', 'log_data', [(52.87, 127.97),	(4072.61, 4145.96)]],
			'subj10': ['2021-11-02_003', 'log_data', [(46.80, 120.55),	(4351.66, 4474.44)]],
			'subj11': ['2021-11-05_002', 'log_data', [(30.44, 152.23),	(4687.38, 4832.41)]],
			'subj12': ['2021-11-08_001', 'log_data', [(102.03, 222.54),	(5005.38, 5130.31)]],
			'subj13': ['2021-11-09_001', 'log_data', [(43.77, 191.85),	(4302.88, 4526.49)]],
			'subj14': ['2021-11-11_001', 'log_data', [(82.07, 205.04),	(4901.64, 5023.67)]],
            'subj15': ['2021-11-18_001', 'log_data', [(63.29, 220.40),	(3851.89, 3983.02)]]
			}
...
baseFolder='/home/erikap/Documents/PIRE/fNIRSdata'
...
################## everything up until here, and then try the SVM with fnirs_data
